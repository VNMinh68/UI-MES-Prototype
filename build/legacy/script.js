...
class Component extends DCLogic {
  ...
  constructor(props){
    ...
    this.state = {
      page:'gantt', cutTab:'capacity', dsoTab:'sprod', dsoSub:'line', dsoLineTab:'perf', spTab:'gen', lset:{}, lsEdit:null, dsoLine:null, mlvLine:null, mlvFs:false, dsoDone:{}, dsoDoneV:2, dsoHand:{}, dsoHandQ:{}, dsoSlips:[], dsoSlipSeq:{}, dsoHandWho:{}, dsoHandAsk:null, gsel:null, gz:1, gopen:{}, cap:{}, capTurns:{}, capOrder:null, dragRow:null, multPlain:3, multEmb:6,
      tab:'weekly', openMonth:this.CURWK.split(' · ')[0], week:this.CURWK, lang:'vi',
      weeks,
      edit:null, bedit:null, bform:null, bslip:null, wslip:null, bqNo:{}, bqSeq:{}, bqLock:{}, addLine:null, khcPlan:null, qrOpen:null, ps:this.psClone(window.PSCHED), psTrash:[], recvLog:[], conf:null, psAdd:null, psTrashOpen:false, sidebarOpen:false, navOpen:{'PRODUCTION PLAN':true,'DASHBOARD':true,'SEWING':true,'FINISHING':true}, dragOver:false, dayOpen:null, daily:{}, freq:{}, wsc:{}, whOpen:null, whQ:'', whErr:'',
      ...
      dsoDefects:this.initDefects(), dsoDefLog:{}, dsoDefTime:{}, dfEdit:null, dfQ:'', dfMsg:'', dsoTap:null, dsoTapQ:'', dsoTapSel:{}, lnRecv:null, lnOpen:{},
      dsoPassLog:{},
  ...
  L = {
    vi:{ bcRoot:'Kế hoạch', bcPage:'Kế hoạch may', upload:'Tải tác nghiệp cắt', mes:'Hệ thống điều hành sản xuất',
      ...
      wsTitle:'PHIẾU GIAO NHẬN PHỤ LIỆU', wsPo:'Số PO #:', wsItem:'Mã phụ liệu #:',
      ...
      spTab1:'General', spTab2:'By Hour', spHrTgt:'Target/giờ',
      spHrTarget:'Target', spHrOut:'Sản lượng',
      spHrNote:'10 khung giờ làm việc · target mỗi giờ = target hiện tại ÷ 10',
      spMlv:'M level', spOut:'Daily production', spTop3:'Top 3 lỗi',
      ...
      lnOrd:'Ordered', lnRecv:'Fabric received', lnRecvTrim:'Received trims',
      lnOut:'Output', lnHand:'Handover',
    ...
    en:{ bcRoot:'Planning', bcPage:'Sewing Schedule', upload:'Upload cutting order', mes:'Manufacturing Execution System',
      ...
      wsTitle:'TRIMS HANDOVER SLIP', wsPo:'PO #:', wsItem:'Item #:',
      ...
      spTab1:'General', spTab2:'By Hour', spHrTgt:'Target/hour',
      spHrTarget:'Target', spHrOut:'Output',
      spHrNote:'10 working-hour slots · hourly target = current target ÷ 10',
      spMlv:'M level', spOut:'Daily production', spTop3:'Top 3 defects',
      spGenProg:'General progress',
  ...
  componentDidMount(){ this._mounted=true; this._esc=e=>{ if(e.key==='Escape'&&this.state.qrOpen) this.closeQr();
      ...
      if(e.key==='Escape'&&this.state.lnRecv&&!this.state.bslip&&!this.state.wslip) this.lnRecvClose();
      ...
      if(e.key==='Escape'&&this.state.wslip) this.wSlipClose();
