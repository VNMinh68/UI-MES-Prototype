...
class Finishing extends MESCore {
  ...
  LMOD = {
    vi:{
      ...
      fivCLast:'TỒN CUỐI THÁNG TRƯỚC',
      fivCInhand:'ĐÃ NHẬN TRONG THÁNG',
      fivCBal:'SL CÂN ĐỐI',
    ...
    en:{
      ...
      fivCLast:'Last Month Stock',
      fivCInhand:"Inhand Q'ty",
      fivCBal:"Balance Q'ty",
